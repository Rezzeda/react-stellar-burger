...
export default function IngredientDetails({ modal = false, setModal, selectedIngredient }) {
    
    const { image, name, calories, proteins, fat, carbohydrates } = selectedIngredient;
//  console.dir(modal);
    return (
        
        <Modal isVisible={modal} onClose={() => setModal(false)} style={{ width: '720px', height: '538px' }}
        >
